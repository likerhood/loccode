...
- Never call this tool with empty arguments. Always provide concrete `search_terms` or `line_nums`.
- For JavaScript/TypeScript/frontend repositories, use `file_path_or_pattern="**/*"` or a JS/TS-specific pattern such as `client/**/*`, `**/*.js`, `**/*.jsx`, `**/*.ts`, or `**/*.tsx`.
...
# Search in a JS/TS frontend repository
search_code_snippets(search_terms=["jetpack/connect/plans", "Jetpack Connect", "subscriber"], file_path_or_pattern="**/*")
            ...
            'properties': {
                ...
                'file_path_or_pattern': {
                    ...
                    'description': 'A glob pattern or specific file path used to filter search results '\
                                   'to particular files or directories. If omitted, LocAgent searches source files across common languages. '\
                                   'For JS/TS repos, prefer "**/*", "client/**/*", "**/*.js", "**/*.jsx", "**/*.ts", or "**/*.tsx". '\
