...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", default="Deep-Software-Analytics/OmniGIRL", type=str, help="Name of dataset or path to JSON file.")
